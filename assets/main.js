$(document).ready(function () {
	...
	$('.wave').click(function() {
		vex.dialog.alert({
			...
			input: '<div class="dialog__content"><ul class="grid grid--wave"><li><div><label>響應方法 A</label><ul><li>step1：在 A4 紙上寫下「#安心台灣運動，我願意__ 」</li><li>step2：手拿宣言錄一段15秒影片，或拍一張照片</li><li>step3：上傳影片/照片到FB或IG，並@好友接力響應</li></ul></div></li><li><label>響應方法 B</label><p>在網站上留下您的宣言，與大家分享！</p><a href="#motion" class="btn btn--block btn--dark icon icon--a icon__more icon__dark"s"><span class="btn__text">立即響應</span></a></li></ul></div>',
		})
	});
